...
| 2026-06-25 | D2 backend | ATT&CK D/P/R tool fields + rationale (migration 0020) + PATCH/responses; `mitre_map` Run-AI endpoint (validates cited tools against the Tech Debt capability list, skips locked rows, returns a what-changed list) — first end-to-end wiring of C1 + C2. `test_attack_run_ai.py`. Full backend suite green. Dashboard/FE remaining. |
