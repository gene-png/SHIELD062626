...
| 2026-06-25 | D4 engine | CSF full-Playbook deterministic engine `app/csf/playbook.py` (totals/levels, evidence cap, the 6 weighted-floor rules, gap, P1/P2/P3) — pure + unit-tested (`test_csf_playbook.py`, 20 cases). The tiered data model, `csf_score`, 10 sub-pages, and exact XLSX remain (multi-increment). |
