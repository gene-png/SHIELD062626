...
| 2026-06-25 | D4 csf_score Run-AI | `POST /csf/services/{id}/run-ai` runs `csf_score` over the tiered rows (5 dims clamped 0-2 + narrative, lock-skip, what-changed) — the 3rd/final service Run-AI loop. `test_csf_run_ai.py`. IG cross-ref + sub-pages + XLSX remain. |
