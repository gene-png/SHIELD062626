...
DOD_CAPABILITIES: tuple[Capability, ...] = (
    # User (8)
    _dod("USR", 1, "User Inventory", "Authoritative user inventory across mission partners and contractors."),
    _dod("USR", 2, "Conditional User Access", "Risk-adaptive conditional access decisions per request."),
    _dod("USR", 3, "Multi-Factor Authentication", "Phishing-resistant MFA mandated for all users."),
    _dod("USR", 4, "Privileged Access Management", "Just-in-time elevation with session recording."),
    _dod("USR", 5, "Identity Federation & User Credentialing", "Federated identity with non-person-entity support."),
    _dod("USR", 6, "Behavioral Contextual ID + Biometrics", "Continuous behavior + biometric signals shape trust."),
    _dod("USR", 7, "Least Privilege Access", "Defaults to least privilege; periodic recertification."),
    _dod("USR", 8, "Continuous Authentication", "Continuous re-authentication based on session risk."),
    # Device (7)
    _dod("DEV", 1, "Device Inventory", "Hardware + firmware inventory maintained continuously."),
    _dod("DEV", 2, "Device Detection & Compliance", "Compliance posture checked before every resource access."),
    _dod("DEV", 3, "Device Authorization w/ Real Time Inspection", "Real-time device authorization with health attestation."),
    _dod("DEV", 4, "Remote Access", "Brokered remote access; per-resource authorization."),
    _dod("DEV", 5, "Partially & Fully Automated Asset, Vulnerability and Patch Management", "Automated patching with measured success rate."),
    _dod("DEV", 6, "Unified Endpoint Management & Mobile Device Management", "Unified policy across endpoint OSes and mobile."),
    _dod("DEV", 7, "Endpoint & Extended Detection & Response", "EDR/XDR coverage with automated containment."),
    # Application & Workload (7)
    _dod("APP", 1, "Application Inventory", "Authoritative application portfolio with criticality."),
    _dod("APP", 2, "Secure Software Development & Integration", "Secure-by-default DevSecOps with SBOM + signing."),
    _dod("APP", 3, "Software Risk Management", "Application-level risk register and remediation tracking."),
    _dod("APP", 4, "Resource Authorization & Integration", "Per-resource authorization integrated with PDP."),
    _dod("APP", 5, "Continuous Monitoring & Ongoing Authorizations", "Continuous ATO with automated artifact collection."),
    _dod("APP", 6, "Application Delivery", "Trusted application delivery with deployment policy gates."),
    _dod("APP", 7, "Software Defined Compute Infrastructure", "Software-defined compute with policy-enforced runtime."),
    # Data (7)
    _dod("DAT", 1, "Data Catalog Risk Alignment", "Catalog data assets and align controls to risk."),
    _dod("DAT", 2, "DoD Enterprise Data Governance", "Enterprise data governance applied to mission data."),
    _dod("DAT", 3, "Data Labeling & Tagging", "Automated data tagging drives downstream enforcement."),
    _dod("DAT", 4, "Data Monitoring & Sensing", "Data loss + exfiltration monitoring across egress points."),
    _dod("DAT", 5, "Data Encryption & Rights Management", "Rights-based access + encryption tied to data tags."),
    ...
    _dod("NET", 4, "Micro Segmentation", "Workload-level microsegmentation enforced by identity-aware proxies."),
    _dod("NET", 5, "Network Inspection & Traffic Analytics", "Encrypted-traffic-aware analytics with privacy safeguards."),
    _dod("NET", 6, "Network Threat Protection", "Inline threat protection with rapid signature distribution."),
    _dod("NET", 7, "Network Access Control", "ZT-aligned NAC; no implicit trust based on network position."),
    # Visibility & Analytics (7)
    _dod("VIS", 1, "Log All Traffic - Network, Data, Apps, Users", "Comprehensive logging with retention policies."),
    _dod("VIS", 2, "Security Information & Event Management (SIEM)", "SIEM correlates events across all pillars."),
    _dod("VIS", 3, "Common Security & Risk Analytics", "Unified risk scoring informs PDP decisions."),
    _dod("VIS", 4, "User & Entity Behavior Analytics", "UEBA detects anomalies across user + entity activity."),
    _dod("VIS", 5, "Threat Intelligence Integration", "Threat intel actively shapes detections + policy."),
    _dod("VIS", 6, "Automated Dynamic Policies", "Analytics output adjusts policy automatically within guardrails."),
    _dod("VIS", 7, "Asset ID & Alert Correlation", "Asset-aware alert correlation drives prioritization."),
    # Automation & Orchestration (7)
    _dod("AUT", 1, "Policy Decision Point & Policy Orchestration", "Centralized PDP enforces unified policy."),
    _dod("AUT", 2, "Critical Process Automation", "Automated response to defined high-confidence patterns."),
    _dod("AUT", 3, "Machine Learning", "ML adapts policy and detections to current telemetry."),
    _dod("AUT", 4, "Artificial Intelligence", "AI-assisted decision support with human-in-the-loop."),
    _dod("AUT", 5, "Security Orchestration, Automation & Response (SOAR)", "SOAR runbooks executed with audit trail."),
    _dod("AUT", 6, "API Standardization", "Standardized APIs across pillars enable orchestration."),
    _dod("AUT", 7, "Security Operations Center & Incident Response", "SOC + IR drilled regularly with measurable outcomes."),
)
