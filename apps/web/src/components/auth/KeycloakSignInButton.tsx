...
export function KeycloakSignInButton(): JSX.Element {
  ...
  return (
    <button
      ...
      className="rounded-md border border-border bg-surface-card px-4 py-2.5 text-sm font-semibold text-ink-primary hover:bg-surface-sunken disabled:cursor-not-allowed disabled:opacity-60"
    >
