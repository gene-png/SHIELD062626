    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <p className="mt-4 text-ink-secondary">
          SHIELD by Kentro is single-tenant per engagement. Each deployment is
          operationally isolated; no client engagement data leaves the
          deployment boundary except through the PII-redaction layer when an AI
          extraction is explicitly approved by the consultant.
        </p>
        <p className="mt-4 text-ink-secondary">
          Full privacy notice and data-processing terms ship with the engagement
