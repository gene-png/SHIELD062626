...
| A04 | Insecure Design | PASS — append-only audit log at two layers; MIME allowlist + size cap on uploads; redaction disclosure shown *before* the upload action; service-request lifecycle has explicit states |
